...
private:
    ...
    char* m_version;                        //HTTP版本号，支持HTTP1.1
    char* m_host;                           //主机名
    ...
    struct stat m_file_stat;                //目标文件的状态，可判断文件是否存在，是否为目录，是否可读等
    ...
    bool add_status_line(int status, const char* titli);
